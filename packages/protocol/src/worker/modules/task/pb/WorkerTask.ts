    ...
    if (_codec == null) {
      _codec = message<WorkerTask>((obj, w, opts = {}) => {
        ...
        if (obj.assignment != null) {
          w.uint32(18)
          WorkerAssignment.codec().encode(obj.assignment, w)
        }
        ...
        while (reader.pos < end) {
          ...
          switch (tag >>> 3) {
            ...
            case 2: {
              obj.assignment = WorkerAssignment.codec().decode(reader, reader.uint32(), {
  ...
  export const codec = (): Codec<WorkerAssignment> => {
    if (_codec == null) {
      _codec = message<WorkerAssignment>((obj, w, opts = {}) => {
        ...
        if ((obj.managerId != null && obj.managerId !== '')) {
          w.uint32(10)
          w.string(obj.managerId)
        }
