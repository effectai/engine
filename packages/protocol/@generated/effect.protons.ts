...
export namespace EffectError {
  ...
  export const decode = (
    ...
    opts?: DecodeOptions<EffectError>,
  ): EffectError => {
...
export namespace EffectAcknowledgment {
  ...
  export const codec = (): Codec<EffectAcknowledgment> => {
    if (_codec == null) {
      _codec = message<EffectAcknowledgment>(
        (obj, w, opts = {}) => {
          if (opts.lengthDelimited !== false) {
            w.fork();
          }
  ...
  export const decode = (
    buf: Uint8Array | Uint8ArrayList,
    opts?: DecodeOptions<EffectAcknowledgment>,
...
export namespace RequestToWork {
  ...
  export const decode = (
    buf: Uint8Array | Uint8ArrayList,
    opts?: DecodeOptions<RequestToWork>,
  ): RequestToWork => {
        ...
        (reader, length, opts = {}) => {
          ...
          while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
              ...
              case 9: {
                obj.templateRequest = TemplateRequest.codec().decode(
                  reader,
                  reader.uint32(),
                  {
              ...
              case 10: {
                obj.templateResponse = Template.codec().decode(
                  reader,
                  reader.uint32(),
                  {
              ...
              case 11: {
                obj.error = EffectError.codec().decode(
                  reader,
                  reader.uint32(),
                  {
              ...
              case 12: {
                obj.ack = EffectAcknowledgment.codec().decode(
                  reader,
                  reader.uint32(),
                  {
              ...
              case 13: {
                obj.requestToWork = RequestToWork.codec().decode(
                  reader,
                  reader.uint32(),
                  {
        ...
        (reader, length, opts = {}) => {
          ...
          while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
              ...
              case 6: {
                obj.template = Template.codec().decode(
                  reader,
                  reader.uint32(),
                  {
...
export namespace TaskAssignment {
  ...
  export const decode = (
    buf: Uint8Array | Uint8ArrayList,
    opts?: DecodeOptions<TaskAssignment>,
  ): TaskAssignment => {
...
export namespace TemplateRequest {
  ...
  export const codec = (): Codec<TemplateRequest> => {
    if (_codec == null) {
      _codec = message<TemplateRequest>(
        (obj, w, opts = {}) => {
          if (opts.lengthDelimited !== false) {
            w.fork();
          }
  ...
  export const decode = (
    buf: Uint8Array | Uint8ArrayList,
    opts?: DecodeOptions<TemplateRequest>,
  ): TemplateRequest => {
