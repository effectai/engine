<template>
  <div class="flex items-center gap-3">
    <div class="space-y-3">
      ...
      <div class="capitalize text-sm text-zinc-400 flex items-center gap-1 mt-1">
        ...
        </svg>Time remaining to {{ type }} task:
        {{ formattedTime }}
      </div>
    </div>
  </div>
  <div class="flex items-center gap-4">
    ...
    <UButton @click="setActiveTask(props.taskRecord)" color="white" class="btn btn-primary" variant="outline">
