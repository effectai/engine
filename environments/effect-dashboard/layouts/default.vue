  ...
  <div class="">
    ...
    <div class="lg:pl-72">
      <div class="sticky top-0 z-40 lg:mx-auto lg:max-w-5xl lg:px-8">
        <div
          class="flex h-16 items-center gap-x-4 border-b border-gray-200 bg-white dark:bg-brand-black dark:border-black px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-0 lg:shadow-none">
