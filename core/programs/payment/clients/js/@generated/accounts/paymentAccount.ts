...
export function getPaymentAccountEncoder(): FixedSizeEncoder<PaymentAccountArgs> {
...
export function getPaymentAccountDecoder(): FixedSizeDecoder<PaymentAccount> {
...
export function getPaymentAccountCodec(): FixedSizeCodec<
  PaymentAccountArgs,
  PaymentAccount
> {
