...
export const EFFECT_PAYMENT_ERROR__INVALID_PAYMENT_ACCOUNT = 0x1777; // 6007
...
export type EffectPaymentError =
  ...
  | typeof EFFECT_PAYMENT_ERROR__INVALID_PAYMENT_ACCOUNT
...
if (process.env.NODE_ENV !== 'production') {
  effectPaymentErrorMessages = {
    [EFFECT_PAYMENT_ERROR__ARITHMETIC_OVERFLOW]: `Arithmetic overflow occurred.`,
    [EFFECT_PAYMENT_ERROR__INVALID_PAYMENT]: `Invalid Payment`,
    [EFFECT_PAYMENT_ERROR__INVALID_PAYMENT_ACCOUNT]: `Invalid Payment Account`,
