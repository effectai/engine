  ...
  <div className="pt-[48px] max-sm:pt-0">
    <div className="max-sm:px-0 flex justify-between z-0 max-md:justify-center">
      <div className="space-y-8 max-w-[400px] flex flex-col items-start max-md:items-center">
        <img className="h-[95px] dark:invert-[1] max-sm:h-[60px]" src="/logo-dark.svg" alt="Effect logo" />
        <div className="font-regular text-[21px] max-sm:text-[18px] text-[#919193] max-md:text-center">Effect AI is a decentralized protocol to **supply**, **assign**, and **execute** human-driven AI tasks efficiently across a distributed network.</div>
        <div className="flex justify-center space-x-2">
        <a className='effect-button effect-button--outlined' href="/docs/introduction/project-overview">
          Get Started
        </a>
         <a className='effect-button effect-button--primary' href="/introduction/project-overview">
          Github
        </a>
        </div>
      </div>
