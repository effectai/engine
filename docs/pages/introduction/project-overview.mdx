...
- **Task Providers** start by broadcasting job collections (called batches) to the network. These batches include tasks like data labeling, transcription, or other AI-driven work, and instructions on how to complete them.
