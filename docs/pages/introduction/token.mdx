import { TokenDistributionPieChart, data } from '../../components/TokenCharts.tsx'
...
deprecated EFX and NFX network tokens. Anybody that holds more than 5
tokens on the 1st of January 2025 at 12PM UTC will have a claimable
EFFECT token allocation. For information on the claim process please
