...
# Provider Nodes
Provider nodes act as the gateway to the network and are responsible for supplying and streaming tasks to the network. They guard the criteria for valid tasks and ensure these criteria are met. 
