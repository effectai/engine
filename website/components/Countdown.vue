<template>
    <div  class="">
        ...
        <div>
            <div class="has-text-centered is-size-4 mt-6">
                If you owned EFX tokens on 1-1-2025 12:00 UTC, you can claim your EFFECT tokens once the claiming portal
            ...
            <div
                ...
                <div class="columns is-mobile is-vcentered is-multiline ">
                    <div class="column">
                        <div class="">
                            <nuxt-link class="mx-2 is-flex is-justify-content-center"
                                to="./news/solana-announcement" exact-active-class="is-active">
