<template>
  <div class="-mt-[76px]">
    <ContentRenderer v-if="data" :value="data">
      <div
        class="relative px-section-x py-section-y bg-[url('../img/blog-header.png')] bg-cover bg-[position:right_0%_bottom_20%]"
      >
        <div class="absolute inset-0 bg-white/60"></div>
        <div class="container max-w-7xl mx-auto relative z-10">
          <h1 class="text-5xl leading-normal lg:text-7xl lg:leading-tight">
            {{ data.title }}
          </h1>
      ...
      <div class="max-w-7xl mx-auto px-4">
        <article class="prose lg:prose-xl font-inter max-w-7xl mx-auto" id="">
