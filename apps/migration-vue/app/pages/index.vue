<template>
  <div
    class="max-w-sm md:max-w-md lg:max-w-xl mx-auto scroll-container"
    v-if="config"
  >
    <div class="prose dark:text-white mt-12" id="step-intro">
      ...
      <p>
        ...
        <u>Solana</u> Blockchain This new token represents a fresh start for our
        mission to enhance human intelligence in the AI era.
      </p>
      ...
      <p>
        ...
        time. Just remember that only tokens held on 01/01/2025 12:00 PM UTC are
      ...
      <p class="mt-5">
        Let’s get started! Click “Begin Migration” below to start your journey
      ...
      <p class="text-xs mt-10 italic">
        If you have questions or encounter issues during the migration, our
        support team is here to help. Simply reach out through our
        <a class="dark:text-white" href="https://t.me/effectai">telegram</a> /
        <a class="dark:text-white" href="https://discord.gg/effectnetwork"
          >discord</a
        >
      </p>
      <p class="mt-1 text-xs italic">
        <b>IMPORTANT</b>: When you reach out for support, expect private
        messages from <u>scammers</u> pretending to be support agents. We will
        never DM you first, And will never ask for your private keys or seed
        phrases. Please be cautious.
      </p>
    </div>
    ...
    >
      <template #authenticate="{ isCompleted }">
        <div>
          <div v-if="isCompleted">
            <div
              class="flex-col flex items-center justify-center gap-3 mt-5"
              v-if="walletMeta"
            >
              <WalletCard
          ...
          <div v-else>
            <div v-if="!computedForeignPublicKey">
              <div class="my-5">
                <p>
                  ...
                  <u>verify ownership</u> of a <b>BSC</b> or <b>EOS</b> account
                  that held or staked EFX tokens on
                  <u>{{ snapshotDate.toLocaleString() }}</u
                  >. You can repeat this process for every account you own that
                  held or staked EFX tokens.
                </p>
              </div>
            ...
            <div v-else>
              ...
              <div class="text-center">
                <div
                  v-if="!migrationAccount"
                  class="text-red-500 text-lg text-center mt-5"
                >
                ...
                <div v-if="walletMeta?.chain == 'EOS'">
                  ...
                  <p class="text-xs">
                    For most accounts the active permission should be used, if
                    however, your active key is of type R1 or it's a multisig,
                    use your owner permission instead.
                  </p>
                </div>
      ...
      <template #solana>
        <div class="w-full">
          ...
          <p>
            Next, we'll need your solana address, this is the address you will
            receive your new EFFECT tokens on.
          </p>
            ...
            <div>
              <div class="flex flex-wrap justify-left items-center gap-2 my-8">
                ...
                <a
                  ...
                  @click="toggleAddress = !toggleAddress"
                  >Manually enter your address</a
                >
              </div>
            </div>
            <div
              class="flex w-full mt-3"
              v-show="!hasSolanaWalletInstalled || toggleAddress"
            >
              <UInput
          ...
          <div
            class="flex flex-wrap justify-left mt-5 items-center gap-1"
            v-if="destinationAddress"
          >
            <b>Chosen address:</b>
            <div class="flex justify-left gap-2">
              <BlockchainAddress :address="destinationAddress" /> |
              <a class="cursor-pointer text-red-500" @click="logout">Switch</a>
            </div>
            <div v-if="balanceLow">
              <p class="text-red-500 mt-3">
                Your SOL balance is low, Your transaction might fail. Please top
                up your account.
              </p>
            </div>
          </div>
      ...
      <template #authorize="{ isCompleted }">
        <div>
          ...
          <div v-else>
            ...
            <p>
              Authorize the migration of your EFX tokens to the Solana network.
            </p>
            <UButton
              @click="authorize"
              class="mt-5"
          ...
          <div v-else class="flex flex-col my-5">
            <div v-if="$device.isMobileOrTablet && !hasSolanaWalletInstalled">
              <h2 class="text-xl my-3 font-bold">
                Authentication and authorization via your mobile wallet were
                successful! 🎉
              </h2>

              To claim your tokens, we need to establish a connection to the
              Solana blockchain. Unfortunately, your current browser or app
              doesn’t support this process. Please open the link below on a
              desktop browser or within an in-app browser of a Solana mobile
            ...
            <div v-else>
              ...
              <ClaimCard
                :foreign-public-key="computedForeignPublicKey"
                :message="message"
                :signature="signature"
